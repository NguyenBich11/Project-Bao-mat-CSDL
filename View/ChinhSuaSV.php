...
<div class="col-md-10 d-flex flex-column align-items-center">
    ...
    <div class="content col-md-8">
        <form id="studentForm" action="#" method="GET" name="formEdit" class="form-container">
            ...
            <div class="d-flex justify-content-end gap-4">
                ...
                <button type="submit" id="submitButton" class="button-me btn btn-warning fw-bold text-dark" name="btnSave">Lưu lại</button>
            </div>
        </form>
    </div>
</div>
